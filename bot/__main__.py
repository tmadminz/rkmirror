...
def restart(update, context):
    ...
    alive.kill()
    clean_all()
    srun(["pkill", "-f", "gunicorn|aria2c|megasdkrest"])
...
<b>/{BotCommands.SpeedtestCommand}</b>: Check Internet Speed of the Host
'''
...
botcmds = [
        ...
        (f'{BotCommands.SpeedtestCommand}','Check Internet Speed of the Host')
    ]
